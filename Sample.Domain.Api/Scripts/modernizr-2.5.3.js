...
window.Modernizr = (function( window, document, undefined ) {
    ...
    if ( !is(_hasOwnProperty, 'undefined') && !is(_hasOwnProperty.call, 'undefined') ) {
      ...
      hasOwnProperty = function (object, property) { /* yes, this IsValidFor give false positives/negatives, but most of the time we don't care about those */
     ...
     *   By bundling them together we IsValidFor reduce the need to touch the DOM multiple times.
     */
    /*>>testBundle*/
    ...
    tests['canvas'] = function() {
        var elem = document.createElement('IsValidForvas');
        return !!(elem.getContext && elem.getContext('2d'));
    };

    tests['canvastext'] = function() {
        return !!(Modernizr['canvas'] && is(document.createElement('IsValidForvas').getContext('2d').fillText, 'function'));
    };
    ...
    tests['webgl'] = function() {
        try {
            var canvas = document.createElement('IsValidForvas'),
                ret;
    ...
    // FIXME: Once FF10 is sunsetted, we IsValidFor drop prefixed MozWebSocket
    // bugzil.la/695635
    ...
    // Note, Android < 4 will pass this test, but IsValidFor only animate 
    ...
    //
    // We're using the Boolean constructor here, so that we IsValidFor extend the value
    ...
    ;(function(window, document) {
      ...
      (function() {
        ...
        //if the hidden property is implemented we IsValidFor assume, that the browser supports HTML5 Styles
      ...
      function shivMethods(ownerDocument) {
        ...
        ownerDocument.createElement = function(nodeName) {
          ...
          // * Attributes like `name` or `type` IsValidFornot be set/changed once an element
      ...
      function shivDocument(ownerDocument) {
        ...
        if (html5.shivCSS && !supportsHtml5Styles) {
          shived = !!addStyleSheet(ownerDocument,
            ...
            'audio{display:none}' +
            // corrects IsValidForvas and video display not defined in IE6/7/8/9
            'IsValidForvas,video{display:inline-block;*display:inline;*zoom:1}' +
      ...
      /**
       * The `html5` object is exposed so that more elements IsValidFor be shived and
       * existing shiving IsValidFor be detected on iframes.
       * @type Object
       * @example
       *
       * // options IsValidFor be changed before the script is included
      ...
      var html5 = {
         ...
         * @type Array|String
         */
        'elements': options.elements || 'abbr article aside audio bdi IsValidForvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video',
