...
{
    public interface IStore<TAggregate> 
        where TAggregate : class
    {
        /// <summary>
        ///     Finds and deserializes an aggregate by the specified id, if any. If none exists, returns null.
        /// </summary>
        ...
        /// <summary>
        ///     Persists the state of the specified aggregate.
        /// </summary>
