...
namespace Microsoft.Its.Domain
{
    ...
    public interface IReservationService
    {
        ...
        Task<bool> Reserve(string value, string scope, string ownerToken, TimeSpan? lease = null);
        ...
        /// <param name="ownerToken">A token indicating the owner of the reservation, which must be provided in order to confirm or cancel the reservation.</param>
        /// <param name="scope">The scope in which the value must be unique.</param>
        Task<bool> Confirm(string value, string scope, string ownerToken);
        ...
        /// <param name="ownerToken">A token indicating the owner of the reservation, which must be provided in order to confirm or cancel the reservation.</param>
        /// <returns></returns>
        Task<bool> Cancel(string value, string scope, string ownerToken);
        ...
        /// <returns></returns>
        Task<string> ReserveAny(string scope, string ownerToken, TimeSpan? lease = null, string confirmationToken = null);
    }
}
